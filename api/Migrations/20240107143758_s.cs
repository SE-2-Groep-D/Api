        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AantalParticipanten = table.Column<int>(type: "int", nullable: false),
                    websiteUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAwnsers = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questionlist", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Questionlist_Onderzoeken_OnderzoekId",
                        column: x => x.OnderzoekId,
                        principalTable: "Onderzoeken",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PagePercentage = table.Column<int>(type: "int", nullable: false),
                    ...
                    TrackingOnderzoekId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PossibleAnswerQuestionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GivenAnswerQuestionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Answer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Answer_Question_GivenAnswerQuestionId",
                        column: x => x.GivenAnswerQuestionId,
                        principalTable: "Question",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Answer_Question_PossibleAnswerQuestionId",
                        column: x => x.PossibleAnswerQuestionId,
                        principalTable: "Question",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackingResultatenId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answer_GivenAnswerQuestionId",
                table: "Answer",
                column: "GivenAnswerQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_Answer_PossibleAnswerQuestionId",
                table: "Answer",
                column: "PossibleAnswerQuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questionlist_OnderzoekId",
                table: "Questionlist",
                column: "OnderzoekId");
